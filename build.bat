...
set COMPILER_INCLUDES=/I%COPPELIA_PROGRAMMING_DIR%\blueZero\include\b0\bindings /I%COPPELIA_PROGRAMMING_DIR%\b0RemoteApiBindings\cpp /I%COPPELIA_PROGRAMMING_DIR%\b0RemoteApiBindings\cpp\msgpack-c\include /I"C:\dev\boost_1_76_0"
